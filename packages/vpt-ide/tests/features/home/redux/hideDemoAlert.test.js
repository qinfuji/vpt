...
import { HOME_HIDE_DEMO_ALERT } from 'src/features/home/redux/constants';

import { hideDemoAlert, reducer } from 'src/features/home/redux/hideDemoAlert';
...
describe('home/redux/hideDemoAlert', () => {
  ...
  it('handles action type HOME_HIDE_DEMO_ALERT correctly', () => {
    ...
    const state = reducer(prevState, { type: HOME_HIDE_DEMO_ALERT });
