...
import { HOME_SHOW_DEMO_ALERT } from 'src/features/home/redux/constants';

import { showDemoAlert, reducer } from 'src/features/home/redux/showDemoAlert';
...
describe('home/redux/showDemoAlert', () => {
  ...
  it('handles action type HOME_SHOW_DEMO_ALERT correctly', () => {
    ...
    const state = reducer(prevState, { type: HOME_SHOW_DEMO_ALERT });
