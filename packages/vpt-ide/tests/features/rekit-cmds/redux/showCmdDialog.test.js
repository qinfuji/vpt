...
import { REKIT_CMDS_SHOW_CMD_DIALOG } from 'src/features/rekit-cmds/redux/constants';
...
describe('rekit-cmds/redux/showCmdDialog', () => {
  it('returns correct action by showCmdDialog', () => {
    expect(showCmdDialog()).to.have.property(
      'type',
  ...
  it('handles action type REKIT_CMDS_SHOW_CMD_DIALOG correctly', () => {
    ...
    const state = reducer(prevState, {
      ...
      data: { dialogType: 'cmd', cmdArgs: { commandName: 'add' } }
    });
