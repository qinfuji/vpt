...
import { COMMON_TEST_ACTION } from 'src/features/common/redux/constants';

import { testAction, reducer } from 'src/features/common/redux/testAction';
...
describe('common/redux/testAction', () => {
  ...
  it('handles action type COMMON_TEST_ACTION correctly', () => {
    const prevState = {};
    const state = reducer(prevState, { type: COMMON_TEST_ACTION });
