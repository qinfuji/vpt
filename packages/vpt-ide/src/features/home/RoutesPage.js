    ...
    return (
      <div className="home-routes-page">
        ...
        >
          ...
          >
            <p>
              This is a rough overview of routing config defined in a feature.{' '}
            </p>
            <p>
              If a route rule isIndex === true and also has a path property then
            ...
            <p>
              NOTE: if route path has parameters, you need to modify the link
              address with correct values after click the route link.{' '}
            </p>
            {routes.length === 0 ? (
              <Alert message="No routing rules defined."
                  showIcon
                  type="info"
              />
            ) : (
